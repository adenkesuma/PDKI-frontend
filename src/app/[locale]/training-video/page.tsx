      ...
      <section className="px-6 lg:px-0 mx-auto container my-12">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-8">
          {videoData?.map((vid: VideoProps) => (
            <div key={vid?._id} className="p-3 bg-gray-100 border border-[#274698]">
              <div className="w-full relative">
                ...
                />
                {vid?.is_private === 1 ?
                  <Link href="https://wa.me/6287720638525" className="absolute -translate-x-[50%] -translate-y-[50%] top-[50%] left-[50%] duration-75 bg-white hover:bg-green-200 py-3 px-4 flex justify-center items-center gap-2">
                    <span className="text-[16px] font-medium">Hubungi admin</span>
                    <TbBrandWhatsapp className="text-xl text-green-600" />
                  </Link>
                  :
                  <Link href={`training-video/${vid?._id}`} className="absolute -translate-x-[50%] -translate-y-[50%] top-[50%] left-[50%] duration-75 bg-white hover:bg-gray-200 py-3 px-4  flex justify-center items-center gap-2">
              ...
              {vid?.is_private === 1 ?
                <div className="bg-orange-100  p-4 flex flex-col space-y-1">
                  <p className="mb-2  font-medium text-center text-sm text-orange-600">Premium Video</p>
                  ...
                  <div className="pt-6 w-full flex gap-4">
                    ...
                    <button
                      ...
                      className="bg-orange-600  px-3 py-1 font-semibold text-xs text-white">
                      Masukkan Token
                    </button>
                  </div>
                </div> :
                <div className="bg-green-100 p-4">
                  <p className="p-2 font-medium text-center text-sm text-green-700">Gratis</p>
