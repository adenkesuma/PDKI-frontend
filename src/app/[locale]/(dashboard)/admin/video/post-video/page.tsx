...
const PostVideo = () => {
    ...
    const postVideo = async (event: any) => {
        ...
        try {
            await fetch(`${process.env.BASE_URL}/api/route/admin/video`, {
                method: "POST",
                body: formData,
                credentials: "include"
            })
                        ...
                        <div className="flex flex-col">
                            <div className="flex gap-8">
                                <input
                                    ...
                                    onChange={handleChange}
                                />
                                <label htmlFor="true" className="text-[14px] font-medium text-gray-800">Youtube</label>
                            </div>
                            <div className="flex gap-8">
                                <input
                                    type="radio"
                                    ...
                                    onChange={handleChange}
                                />
                                <label htmlFor="false" className="text-[14px] font-medium text-gray-800">Video Lokal</label>
                            </div>
                        </div>
                    </div>
                    {
