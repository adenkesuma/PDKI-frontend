          ...
          >
            ...
            <div className="flex flex-col justify-between">
              <div>
                ...
                <p className="text-gray-600 font-medium line-clamp-2 mt-1 text-xs">{item.description}</p>
              </div>
              <div className="mt-4 flex justify-between items-center gap-8">
                <span className="text-xs text-gray-600 font-semibold whitespace-nowrap text-normal overflow-hidden">{item.location}</span>
                <span className="text-xs text-gray-600 font-semibold whitespace-nowrap text-normal overflow-hidden text-end">{item.organizer}</span>
              </div>
            </div>
